<template>
  <div class="mobile-room-detail-container">
    <!-- 房间内等待 -->
    <div v-if="currentView === 'room'" class="room-view">
      <div class="room-header">
        ...
        <el-button @click="leaveRoom" type="danger" size="small">离开房间</el-button>
      </div>
    ...
    <div v-else-if="currentView === 'scoring'" class="scoring-view">
          ...
          <div class="score-list">
            ...
            >
              ...
              <div class="score-details">
                ...
                <div class="feedback" v-if="score.feedback && !score.feedback.includes('打断')">{{ score.feedback }}</div>
              </div>
      ...
      <div class="scoring-actions">
        <el-button v-if="isGameFinished" type="primary" @click="backToLobby" size="large">返回大厅</el-button>
  ...
  try {
    ...
    if (response.success && response.room) {
      ...
      if (status === 'FINISHED') {
        ...
        setTimeout(() => router.push('/mobile/battle-room'), 2000)
        return
    ...
    setTimeout(() => router.push('/mobile/battle-room'), 1500)
  }
}
...
const checkRoomStatus = (status: string) => {
  ...
  if (status === 'FINISHED' && currentView.value !== 'result') {
    ...
    setTimeout(() => {
      router.push('/mobile/battle-room')
    }, 3000)
  }
